...
export default class ConstantsMidra extends Constants {
    ...
    static override readonly tbarPositionReadPath = ['status', 'pp', 'tbarPosition']
    static override readonly hasLayerKeying = false
    static override readonly hasStrobeEffect = false
    ...
    static override readonly stillLibraryPath = 'DEVICE/device/stillLibrary/bankList'

    static override readonly outputRateInMilliHertz = false
}